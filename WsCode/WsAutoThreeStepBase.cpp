...
//
//  @ Project : Wildstang
//  @ File Name : WsAutoThreeStepBase.cpp
//  @ Date : 2/8/2009
//  @ Author : 
//
//
...
WsAutoThreeStepBase::WsAutoThreeStepBase()
{
...
void WsAutoThreeStepBase::initParams(void)
{
    // Attributes for init
    ...
    a_drive3CrabAngle = 0;
    a_drive3Vector.a_speed = 0;
    a_drive3Vector.a_direction = 0;
    a_drive3Timeout = 0;
...
bool WsAutoThreeStepBase::run(void )
{
    bool done = false;
    double time = 0;
    ...
    switch(a_progState)
    {
        ...
        case AUTO_STATE_DRIVE1:
            ...
            {
                a_progState = AUTO_STATE_COAST1;
            }
            break;
        case AUTO_STATE_COAST1:
            if(coastPointWheels(a_coast1CrabAngle,
                                a_coast1Timeout, &time) == true)
            {
        ...
        case AUTO_STATE_DRIVE2:
            ...
            {
                a_progState = AUTO_STATE_COAST2;
            }
            break;
        case AUTO_STATE_COAST2:
            if(coastPointWheels(a_coast2CrabAngle,
                                a_coast2Timeout, &time) == true)
            {
                a_progState = AUTO_STATE_DRIVE3;
            }
            break;
        case AUTO_STATE_DRIVE3:
            if(driveByTime(&a_drive3Vector, a_drive3CrabAngle,
                           a_drive3Timeout, &time) == true)
            {
                a_progState = AUTO_STATE_COAST3;
            }
            break;
        case AUTO_STATE_COAST3:
            if(coastPointWheels(a_coast3CrabAngle,
                                a_coast3Timeout, &time) == true)
            {
